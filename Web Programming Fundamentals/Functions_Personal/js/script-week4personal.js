...
setTimeout("beginnersPack('You have received 20 Scrolls, 30 Arrows, Beginners armor, and a letter from Lord Yoshuba.')", 20000);
}

var answer = prompt("Would you like to continue?", "Yes");

If (answer == Yes)

{
	document.write("Preparing your beginners pack")
